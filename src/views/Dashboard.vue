<template>
  <div class="py-4 container-fluid" v-if="!userType === 'admin'">
    <div class="row mb-4">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 col-sm-6">
            <mini-statistics-card
              :title="{ text: 'Revenue Breakdown', value: '$53k' }"
          ...
          <div class="col-lg-3 col-md-6 col-sm-6 mt-lg-0 mt-4">
            <mini-statistics-card
              :title="{ text: 'Net Income', value: '2,300' }"
          ...
          <div class="col-lg-3 col-md-6 col-sm-6 mt-lg-0 mt-4">
            <mini-statistics-card
              :title="{ text: 'Total Expenses', value: '3,462' }"
          ...
          <div class="col-lg-3 col-md-6 col-sm-6 mt-lg-0 mt-4">
            <mini-statistics-card
              :title="{ text: 'Total Revenue', value: '$103,430' }"
